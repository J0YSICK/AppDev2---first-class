...
class _MyAppState extends State<MyApp> {
  //create a objet to connect the link from the google maps
  ...
  //write a function that launched this URL
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Column(
          children: [
            ElevatedButton(onPressed: _openMaps, child: Text('Click for directions'))
          ],
        ),
      ),
    );
